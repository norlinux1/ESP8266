...
#define LCD_DATA_PORT PORTD	//define MCU port connected to LCD data pins
#define LCD_CONTROL_PORT PORTD	//define MCU port connected to LCD control pins
#define LCD_DATA_DDR DDRD	//define MCU direction register for port connected to LCD data pins
#define LCD_CONTROL_DDR DDRD	//define MCU direction register for port connected to LCD control pins
